...
'''
              ...
              class_('is_null')..extend = 'UnaryPred',
              class_('not_null')..extend = 'UnaryPred',
              class_('not')..extend = 'UnaryPred',
              class_('and')..extend = 'BinaryPred',
              class_('or')..extend = 'BinaryPred',
              class_('multi_and')..extend = 'MultiPred',
              class_('multi_or')..extend = 'MultiPred',
              class_('eq')..extend = 'BinaryPred',
              class_('not_eq')..extend = 'BinaryPred',
              class_('like')..extend = 'BinaryPred',
              class_('gt')..extend = 'BinaryPred',
              class_('lt')..extend = 'BinaryPred',
              class_('ge')..extend = 'BinaryPred',
              class_('le')..extend = 'BinaryPred',
              class_('abs')..extend = 'UnaryExpr',
              class_('plus')..extend = 'BinaryExpr',
              class_('minus')..extend = 'BinaryExpr',
              class_('times')..extend = 'BinaryExpr',
              class_('join')
                ..isImmutable = true
                ..members = [
          ...
          class_('fkey_path_entry')
            ...
            ..members = [
              member('name')
                ...
                ..ctors = [''],
              member('table')
                ..doc = 'Table doing the referring'
                ..type = 'Table'
                ..access = RO
                ..ctors = [''],
              member('ref_table')
                ..doc = 'Table referred to with foreign key constraint'
                ..type = 'Table'
                ..access = RO
                ..ctors = [''],
...
'''
                  ..type = 'Map<String, List<FkeyPathEntry>>'
                  ..access = IA
                  ..classInit = {},
              ])),
            ...
            ..members = ([
              ...
              ..addAll([
                member('column_map')
                  ...
                  ..access = IA
                  ..classInit = {},
                member('value_columns')
                  ..type = 'List<Column>'
                  ..access = RO,
                member('foreign_keys')
                  ..type = 'Map<String, ForeignKey>'
                  ..access = RO,
                member('schema')
                  ..type = 'Schema'
                  ..access = RO
        ...
        ..parts = [
          part('engine')
            ..classes = [
              ...
              class_('mysql_visitor')..extend = 'SqlVisitor',
            ],
          part('schema_writer')
            ..classes = [
