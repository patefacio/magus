...
class Schema {
  Schema(this._engine, this._name, this._tables) {
    ...
    tables.forEach((Table table) {
      ...
      if (!_dfsFkeyPaths.containsKey(tname)) {
        ...
        path.where((fpe) => fpe.table == table).forEach((FkeyPathEntry fpe) {
    ...
    _orderTablesByRelations(tables.where((t) => !deps.containsKey(t)));
  ...
  List<FkeyPathEntry> _dfsTableVisitorImpl(
      Table table, List<FkeyPathEntry> entries) {
  ...
  Schema._fromJsonMapImpl(Map jsonMap)
      : _name = jsonMap["name"],
        ...
        _tables = ebisu.constructListFromJsonData(
            jsonMap["tables"], (data) => Table.fromJson(data)),
        // tableMap is Map<String, Table>
        _tableMap = ebisu.constructMapFromJsonData(
            jsonMap["tableMap"], (value) => Table.fromJson(value)),
        // dfsFkeyPaths is Map<String, List<FkeyPathEntry>>
        _dfsFkeyPaths = ebisu.constructMapFromJsonData(
            jsonMap["dfsFkeyPaths"], (value) => value);
...
class ForeignKeySpec {
  ...
  ForeignKeySpec._fromJsonMapImpl(Map jsonMap)
      : name = jsonMap["name"],
        ...
        refColumns = ebisu.constructListFromJsonData(
            jsonMap["refColumns"], (data) => data);
}
...
class ForeignKey {
  ...
  ForeignKey._fromJsonMapImpl(Map jsonMap)
      : _name = jsonMap["name"],
        ...
        _columns = ebisu.constructListFromJsonData(
            jsonMap["columns"], (data) => Column.fromJson(data)),
        _refTable = Table.fromJson(jsonMap["refTable"]),
        // refColumns is List<Column>
        _refColumns = ebisu.constructListFromJsonData(
            jsonMap["refColumns"], (data) => Column.fromJson(data));
...
class UniqueKey {
  ...
  UniqueKey._fromJsonMapImpl(Map jsonMap)
      : name = jsonMap["name"],
        // columns is List<Column>
        columns = ebisu.constructListFromJsonData(
            jsonMap["columns"], (data) => Column.fromJson(data));
}
...
class Table {
  ...
  Table._fromJsonMapImpl(Map jsonMap)
      : _name = jsonMap["name"],
        ...
        _primaryKey = ebisu.constructListFromJsonData(
            jsonMap["primaryKey"], (data) => Column.fromJson(data)),
        // uniqueKeys is List<UniqueKey>
        _uniqueKeys = ebisu.constructListFromJsonData(
            jsonMap["uniqueKeys"], (data) => UniqueKey.fromJson(data)),
        // foreignKeySpecs is List<ForeignKeySpec>
        _foreignKeySpecs = ebisu.constructListFromJsonData(
            jsonMap["foreignKeySpecs"],
            (data) => ForeignKeySpec.fromJson(data)),
        // columnMap is Map<String, Column>
        _columnMap = ebisu.constructMapFromJsonData(
            jsonMap["columnMap"], (value) => Column.fromJson(value)),
        // valueColumns is List<Column>
        _valueColumns = ebisu.constructListFromJsonData(
            jsonMap["valueColumns"], (data) => Column.fromJson(data)),
        // foreignKeys is Map<String, ForeignKey>
        _foreignKeys = ebisu.constructMapFromJsonData(
            jsonMap["foreignKeys"], (value) => ForeignKey.fromJson(value));
